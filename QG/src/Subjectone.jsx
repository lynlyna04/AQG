    ...
    try {
      ...
      if (verbList.length === 0) {
        ...
        localStorage.setItem(
          "allExtractedVerbs",
          JSON.stringify(["لم يتم العثور على أفعال."])
        ); // ✅ Store here
        return;
      }
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center mt-[100px]">
        <h2 className="mb-8 text-[26px]">{language === 'ar' ? "توليد الامتحان" : "Exam Generation"}</h2>
        {/* Input Box */}
        <div className="w-[500px] rounded-[10px] h-60 border border-black shadow-md overflow-hidden mb-6">
          <div className="bg-[#FFB3B3] p-2 border-b border-black">
            <h3
              className="text-l font-bold text-black text-center"
        ...
        <div className="flex gap-4 ">
          ...
          <div className={` ${language === "ar" ? "mt-[8px]" : "mt-[8px]"}`}>
            ...
            <label
              htmlFor="file-upload"
              className={`bg-[#FFEF9D] text-[14px] font-semibold border-2 border-black py-[11px] px-4 rounded-[15px] ${
                isLoading
          ...
          <button
            ...
            className={`bg-[#FFEF9D] text-[14px] font-semibold border-2 border-black px-6 py-2 rounded-[15px] ${
