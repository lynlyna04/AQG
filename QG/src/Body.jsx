  ...
  return (
    <div>
      <div className="bg-[#21FFAE] h-250 mb-30 relative">
        ...
        {/* Box 1 */}
        <div
          className={`w-[250px] rounded-[10px] border-1 border- shadow-md overflow-hidden mt-[-470px] ${
            language === "ar" ? "ml-220" : "ml-65"
          }`}
        >
          <div
            className="bg-[#FFB3B3] p-4 border-b border-black"
          ...
          <div className="bg-white p-4" dir={language === "ar" ? "rtl" : "ltr"}>
            ...
            >
              {language === "ar"
                ? "الصق فقرة أو قصة أو نص موضوع للبدء."
                : "Paste an Arabic paragraph, story, or topic text to get started."}
            </p>
          </div>
        </div>
        ...
        {/* Box 2 */}
        <div
          className={`w-[250px] rounded-[10px] border-1 border- shadow-md overflow-hidden mt-[-20px] ${
            language === "ar" ? "ml-170" : "ml-110"
          }`}
        >
          <div
            className="bg-[#FFB3B3] p-4 border-b border-black"
          ...
          <div className="bg-white p-4" dir={language === "ar" ? "rtl" : "ltr"}>
            ...
            >
              {language === "ar"
                ? "خصص وانقر لتوليد أسئلة و اقتراحات مواضيع مخصصة باستخدام الذكاء الاصطناعي."
                : "Customize and Click to generate custom questions and subject suggestions using AI."}
            </p>
          </div>
        </div>
        ...
        {/* Box 3 */}
        <div
          className={`w-[280px] rounded-[10px] border-1 border- shadow-md overflow-hidden mt-[-20px] ${
            language === "ar" ? "ml-120" : "ml-160"
          }`}
        >
          <div
            className="bg-[#FFB3B3] p-4 border-b border-black"
        ...
        <div className="max-w-6xl mx-auto px-4 mt-24">
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            ...
            <div className="w-[320px] h-[250px] bg-white border border-black shadow-md rounded-[15px] p-6 text-center">
              ...
              <p className="text-gray-700">
                {language === "en"
                  ? "Paste your text and get questions or customized topics with a single click."
                  : "ألصق نصك واحصل على أسئلة أو مواضيع مخصصة بنقرة واحدة فقط."}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#FFB3B3] h-250 mb-30">
        ...
        <img
          src="/Quote mark.png"
          className={`absolute mt-[120px] px-30 ${
            language === "ar" ? "scale-x-[-1] ml-220" : ""
          }`}
        />

        <div className="py-45 px-55">
          <h2
            className={`font-bold text-[48px] leading-tight ${
              language === "ar" ? "text-right" : ""
            }`}
            dir={language === "ar" ? "rtl" : "ltr"}
          >
          ...
          {/* Card 1 */}
          <div
            className={`bg-[#FFFF] rounded-[10px] p-6 shadow w-[380px] px-10 ml-5 ${
              language === "ar" ? "text-right" : "text-left"
            }`}
            dir={language === "ar" ? "rtl" : "ltr"}
          >
            <img
              src="./Quote mark (1).png"
              className={`mb-2 ${
                language === "ar" ? "mr-[-15px] scale-x-[-1]" : "ml-[-15px]"
              }`}
            />
            ...
            <p className="text-[18px] font-semibold">
              {language === "ar" ? "الأستاذة ليلى" : "Ms. Layla"}
            </p>
          ...
          {/* Card 2 */}
          <div
            className={`bg-[#FFFF] rounded-[10px] p-4 shadow w-[480px] px-10 ml-105 mt-[-330px] ${
              language === "ar" ? "text-right" : "text-left"
            }`}
            dir={language === "ar" ? "rtl" : "ltr"}
          >
            ...
            <p className="text-[18px] font-semibold">
              {language === "ar" ? "أمينة" : "Amina"}
            </p>
            <p className="text-[14px] text-gray-600">
              {language === "ar"
                ? "أم تقوم بتعليم أبنائها في المنزل"
                : "Home schooling mom"}
            </p>
          </div>
          ...
          {/* Card 3 */}
          <div
            className={`bg-[#FFFF] rounded-[10px] p-4 shadow w-[380px] px-10 ml-105 mt-5 ${
              language === "ar" ? "text-right" : "text-left"
            }`}
            dir={language === "ar" ? "rtl" : "ltr"}
          >
            ...
            <p className="text-[18px] font-semibold">
              {language === "ar" ? "الأستاذ يوسف" : "Mr Youcef"}
            </p>
            <p className="text-[14px] text-gray-600">
              {language === "ar" ? "مدرس لغة" : "Language tutor"}
            </p>
          </div>
        </div>
        ...
        <img
          src="./Group 79.png"
          className={`${language === "ar" ? "mt-[-40px]" : "mt-[-30px]"} `}
        />
      </div>
      ...
      <div className="w-150 max-w-4xl mx-auto mt-20 mb-20 px-4">
        ...
        <div className="space-y-6" dir={language === "ar" ? "rtl" : "ltr"}>
          {[
            {
              question:
                language === "ar" ? "ما هو Taqyeem؟" : "What is Taqyeem?",
              answer:
                language === "ar"
            ...
            {
              question:
                language === "ar" ? "هل هو مجاني؟" : "Is it free to use?",
              answer:
                language === "ar"
            ...
            <details
              key={index}
              className="bg-white border border-black rounded-x1 p-4"
            >
